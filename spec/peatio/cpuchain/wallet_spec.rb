RSpec.describe Peatio::CPUchain::Wallet do
  let(:wallet) { Peatio::CPUchain::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::CPUchain::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::CPUchain::Wallet::SUPPORTED_SETTINGS))
    end
  end
